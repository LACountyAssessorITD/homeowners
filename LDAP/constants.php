<?php
	...
	if(ON_AZURE) {
		...
		define("SERVERNAME",'Assessor');
		define("UID",'zhdllwyc');
		define("PWD",'A$$essortrain456');
		define("DATABASENAME",'homeowner_test');
		define("HOX_DATABASE", 'HOX_USC');
		define("ENCRPYTIONMETHOD", 'AES-256-CBC');
		define("IV", '1234567812345678');
		define("HASH", '25c6c7ff35b9979b151f2136cd13b0ff');
		...
		define("SERVERNAME","HTRAINTRACDEV-V");
		define("UID","superadmin");
		define("PWD",'admin');
		define("DATABASENAME",'homeowner_test');
		define("HOX_DATABASE", 'HOX_USC');
		define("ENCRPYTIONMETHOD", 'AES-256-CBC');
